 ...
 */
public class DragSortGridLayout0 extends GridLayout {
    ...
    public DragSortGridLayout0(Context context) {
        this(context, null);
    }

    public DragSortGridLayout0(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DragSortGridLayout0(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        transition.setDuration(500); // 指定动画的事件
    ...
    View mDragView;
    private OnLongClickListener mLongListener = new OnLongClickListener() {
